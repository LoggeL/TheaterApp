...
| Flutter-Tests | 54 Tests bestanden, einschließlich Kontenübersicht bei 320 und 1100 Pixeln, Suche nach Rolle, Auswahl einer Registrierung zur Person, Leser, Kontowechsel und Offline-Warteschlange |
| Backend | 30 Tests bestanden, einschließlich atomarem Stammdatenimport, wiederholbarer Anwendung und unveränderten Login-Freigaben: Rechte, Freigabe, Versionskonflikte, Idempotenz, Späterkommen, Push-Wiederholung und Regiebrücke |
...
| Android-Galerie und Profil | Gerätetest mit echtem Firebase und Dokploy bestanden: Profilupload, Profil speichern und zurücklesen, Kalender, Lightbox-Bildwechsel, geschützter Originalabruf und Abmeldung. Der native Dateiauswahldialog wurde nicht automatisiert bedient |
...
| Erweiterungen 0.4.0 | Terminbeschreibungen und zwölf Arten, mehrere frei verwaltbare Aufgabenrollen, allgemeine Abstimmungen und sichtbare Administration. 54 Flutter- und 30 Backend-Tests; Android-Emulatortest mit lokalem Firebase für Speichern und Zurücklesen bestanden |
